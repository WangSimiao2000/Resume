...
\begin{minipage}[c]{0.60\textwidth}
  \begin{center}
    ...
    \begin{tabular}{c c}
      ...
      \faBlog\ \href{https://blog.mickeymiao.cn}{Blog}
    \end{tabular}
  \end{center}
\end{minipage}%
\hfill
...
C++ · OpenGL · GLSL
\begin{itemize}
  \item 建模与渲染：蒙特卡洛路径追踪、斯涅尔折射、菲涅尔反射、法线贴图、Blinn-Phong 光照 \href{https://github.com/WangSimiao2000/Foundations_of_Modelling_and_Rendering}{\faGithub}
...
\begin{tabularx}{\textwidth}{@{} l X}
  ...
  \textbf{图形相关} & OpenGL、LVGL、Unreal Engine \\
